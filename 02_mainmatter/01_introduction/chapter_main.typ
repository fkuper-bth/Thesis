...
Die vorliegende Arbeit stellt einen Versuch dar, diese Potenziale mit Hilfe der Ergebnisse für Entwickler*innen leichter verfügbar zu machen, indem es die Produktion einer #utils.gls-long("visual_novel") unter Berücksichtigung der Anforderungen an diese Art von Spiel im Bereich der #utils.gls-plural("serious_game") vereinfacht.
