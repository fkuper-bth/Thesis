...
Im Rahmen dieser Arbeit wird also einerseits eine Bibliothek konzipiert und umgesetzt, die die Verwendung von Twine Geschichten in Anwendungen auf verschiedenen Plattformen ermöglicht, und andererseits eine solche Anwendung beispielhaft erstellt, die diese Bibliothek verwendet, um die Anwendung der Bibliothek zu demonstrieren. Diese Anwendung soll sich an der KITE II @hochschule_heilbronn_kite_2023 Anwendung orientieren, die sich zum Zeitpunkt der Verfassung dieser Arbeit noch in Entwicklung befindet.
